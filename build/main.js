  ...
  return function (e) {
    ...
    t["default"] = function (e) {
      var t = e || {},
          ...
          s = f[0],
          l = f[1],
          m = (0, u.useState)(i.Time.getSecondsFromExpiry(s)),
          d = o(m, 2),
          p = d[0],
          v = d[1],
          y = (0, u.useState)(!0),
      ...
      function S() {
        g.current && (h(!1), clearInterval(g.current), g.current = void 0);
      }

      function w() {
        S(), i.Validate.onExpire(a) && a();
      }

      function O() {
        g.current || (h(!0), g.current = setInterval(function () {
          var e = i.Time.getSecondsFromExpiry(s);
          e <= 0 && w(), v(e);
        }, 1e3));
      }

      return (0, u.useEffect)(function () {
        if (i.Validate.expiryTimestamp(s)) {
          var e = i.Time.getSecondsFromExpiry(s),
              t = Math.floor(1e3 * (e - Math.floor(e)));
          v(e), t > 0 ? function (e, t) {
            h(!0), g.current = setTimeout(function () {
              var e = i.Time.getSecondsFromExpiry(s);
              v(e), e <= 0 ? w() : (g.current = void 0, O());
            }, t);
          }(0, t) : O();
        }

        return S;
      }, [s]), n({}, i.Time.getTimeFromSeconds(p), {
        start: O,
    ...
    t["default"] = function (e) {
      var t = e || {},
          r = t.autoStart,
          a = t.offsetTimestamp,
          c = (0, u.useState)(i.Time.getSecondsFromExpiry(a || 0)),
          f = o(c, 2),
          s = f[0],
          l = f[1],
          m = (0, u.useState)(r),
      ...
      function T() {
        y.current && (v(!1), clearInterval(y.current), y.current = void 0);
      }

      function b() {
        y.current || (v(!0), y.current = setInterval(function () {
          return l(function (e) {
            return e + 1;
          });
        }, 1e3));
      ...
      return (0, u.useEffect)(function () {
        return r && b(), T;
      }, []), n({}, i.Time.getTimeFromSeconds(s), {
        start: b,
        pause: function pause() {
          T();
        },
        reset: function reset(e) {
          T(), l(i.Time.getSecondsFromExpiry(e || 0)), r && b();
        },
        isRunning: p
      });
    };
    ...
    t["default"] = function (e) {
      ...
      return (0, u.useEffect)(function () {
        return s.current || (s.current = setInterval(function () {
          return f(i.Time.getSecondsFromTimeNow());
        }, 1e3)), l;
      }, []), n({}, i.Time.getFormattedTimeFromSeconds(c, t));
    };
...
var secondsParser = function secondsParser(_ref) {
  var days = _ref.days,
      hours = _ref.hours,
...
var App = function App() {
  var _useStopwatch = (0,react_timer_hook__WEBPACK_IMPORTED_MODULE_1__.useStopwatch)(),
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    ...
    scales: 0
      ...
      practiceTime = _useState2[0],
      setPracticeTime = _useState2[1];

  var handleStart = function handleStart() {
    start();
  };

  var handleStopChords = function handleStopChords() {
    pause();
    var finalSeconds = secondsParser({
      days: days,
      hours: hours,
      minutes: minutes,
      seconds: seconds
    });
    setPracticeTime(function (prevState) {
  ...
  var handleStopScales = function handleStopScales() {
    pause();
    var finalSeconds = secondsParser({
      days: days,
      hours: hours,
  ...
  var handleStopNew = function handleStopNew(event) {
    ...
    if (practiceTime.hasOwnProperty(subject)) {
      setPracticeTime(function (prevState) {
        return _objectSpread(_objectSpread({}, prevState), {}, _defineProperty({}, subject, prevState.subject + finalSeconds));
      });
      reset();
    } else {
      setPracticeTime(function (prevState) {
        return _objectSpread(_objectSpread({}, prevState), {}, _defineProperty({}, subject, finalSeconds));
      });
      reset();
    }
  };

  var totalTime = function totalTime() {
    var time = Object.values(practiceTime).reduce(function (a, b) {
      return a + b;
    });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Practice clock"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, Number(minutes).toLocaleString('en-US', {
    minimumIntegerDigits: 2,
    useGrouping: false
  }), ":", Number(seconds).toLocaleString('en-US', {
    minimumIntegerDigits: 2,
    useGrouping: false
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Practice chords: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    onClick: handleStart
  }, "Start"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    onClick: handleStopChords
  }, "Stop")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Practice scales: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    onClick: handleStart
  }, "Start"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    onClick: handleStopScales
  }, "Stop")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
    onSubmit: handleStopNew
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Practice something else: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
    placeholder: "What?",
    name: "subject"
    ...
    type: "submit"
  }, "Stop"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Time spent:"), Object.entries(practiceTime).map(function (_ref2) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", {
      key: key
    }, key, ": ", new Date(value * 1000).toISOString().substr(11, 8));
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Total time: ", totalTime()));
};
